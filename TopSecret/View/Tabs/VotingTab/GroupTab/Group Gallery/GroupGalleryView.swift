            ...
            VStack{
                ...
                HStack{
                    ...
                    Spacer()
                        ...
                        SearchBar(text: $searchRepository.searchText, placeholder: "Gallery")
                ...
                //Gallery
                        ...
                        }else if groupGalleryVM.retrievedImages.isEmpty && groupGalleryVM.isLoading {
                            ProgressView()
                            Spacer()
                        }else{
                            Text("No Images!")
...
//            }
            ...
            GroupGalleryPhotoPicker(selectedImages: $selectedImages, picker: $isShowingPhotoPicker)
        }
