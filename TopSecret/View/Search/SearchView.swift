...
struct SearchView: View {
    ...
    var body: some View {
        ZStack{
            ...
            NavigationLink(destination: GroupProfileView(group: $selectedGroup, isInGroup: selectedGroup.users.contains(userVM.user?.id ?? " "), showProfileView: $openGroupProfile), isActive: $openGroupProfile){
                EmptyView()
            }
